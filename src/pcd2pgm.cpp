...
int main(int argc, char **argv) {
  ...
  private_nh.getParam("file_directory", file_directory);

  private_nh.getParam("file_name", file_name);

  pcd_file = file_directory + file_name + pcd_format;

  private_nh.getParam("thre_z_min", thre_z_min);
  private_nh.getParam("thre_z_max", thre_z_max);
  private_nh.getParam("flag_pass_through", flag_pass_through);
  private_nh.getParam("thre_radius", thre_radius);
  private_nh.getParam("map_resolution", map_resolution);
  private_nh.getParam("thres_point_count", thres_point_count);
  private_nh.getParam("map_topic_name", map_topic_name);
